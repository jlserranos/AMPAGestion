...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Cuota>().HasData(
            new Cuota { Id = 1, Fecha = new DateTime(2024, 9, 10), Concepto = "Cuota anual 2024-25", Importe = 25m, Metodo = MetodoPago.Bizum,        SocioId = 1, CursoAcademico = "2024-2025" },
            new Cuota { Id = 2, Fecha = new DateTime(2024, 9, 12), Concepto = "Cuota anual 2024-25", Importe = 25m, Metodo = MetodoPago.Transferencia, SocioId = 3, CursoAcademico = "2024-2025" }
        );
