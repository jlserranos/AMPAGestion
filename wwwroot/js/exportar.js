...
// ── Cámara: añadir atributo capture al InputFile ───────────────────────
window.activarCapturaCamara = function (elementId) {
...
// ── Añadir atributo capture a input de cámara ─────────────────────────
// Se llama desde SubidaMultiple después de renderizar
window.setCaptureAttribute = function (elementId) {
    const el = document.getElementById(elementId);
